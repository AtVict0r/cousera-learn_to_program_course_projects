...
def make_str_from_column(board, column_index):
    ...
    'NS'
    """
    return ''.join([board[char][column_index] for char in range(len(board))])
...
def word_score(word):
    ...
    if word_len in range(3, 7):
        return word_len * 1
    elif word_len in range(7, 10):
        return word_len * 2
    elif word_len >= 10:
        return word_len * 3
...
def read_board(board_file):
    ...
    """
    return [list(line.rstrip()) for line in board_file]